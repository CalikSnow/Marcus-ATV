...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { cod: @produto.cod, fornecedor: @produto.fornecedor, nome: @produto.nome, tipo: @produto.tipo, validade: @produto.validade } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { cod: @produto.cod, fornecedor: @produto.fornecedor, nome: @produto.nome, tipo: @produto.tipo, validade: @produto.validade } }
